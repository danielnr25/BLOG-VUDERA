               ...
               <div className="w-full p-8 lg:w-1/2">
                  ...
                  <form action="">
                     ...
                     <div className="text-end mt-3">
                        <Link className="underline text-gray-900 hover:text-primary hover:font-semibold">forget password</Link>
                     </div>
                  ...
                  <p className="text-sm text-gray-900 mt-4 text-center font-medium">No tiene cuenta? <Link to="/register"className="underline text-primary font-bold hover:text-indigo-700">Registrarse</Link></p>
               </div>
